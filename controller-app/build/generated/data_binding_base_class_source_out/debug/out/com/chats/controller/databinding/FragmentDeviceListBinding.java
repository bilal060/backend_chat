...
public final class FragmentDeviceListBinding implements ViewBinding {
  ...
  private FragmentDeviceListBinding(@NonNull SwipeRefreshLayout rootView,
      @NonNull RecyclerView recyclerViewDevices, @NonNull SwipeRefreshLayout swipeRefreshLayout,
  ...
  public static FragmentDeviceListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDeviceListBinding((SwipeRefreshLayout) rootView, recyclerViewDevices,
          swipeRefreshLayout, textViewEmpty);
    }
